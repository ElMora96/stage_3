...
#Holydays 
feste = {dt.date(2018,1,1), dt.date(2018,1,6), dt.date(2018,4,1), dt.date(2018,4,2), dt.date(2018,4,25), dt.date(2018,5,1), dt.date(2018,6,1), dt.date(2018,8,15), dt.date(2018,11,1), dt.date(2018, 12, 8), dt.date(2018,12,25), dt.date(2018,12,26),
		dt.date(2019,1,1), dt.date(2019,1,6), dt.date(2019,4,21), dt.date(2019,4,22), dt.date(2019,4,25), dt.date(2019,5,1), dt.date(2019,6,1), dt.date(2019,8,15), dt.date(2019,11,1), dt.date(2019, 12, 8), dt.date(2019,12,25), dt.date(2019,12,26),
		dt.date(2020,1,1), dt.date(2020,1,6), dt.date(2020,4,12), dt.date(2019,4,13), dt.date(2020,4,25), dt.date(2020,5,1), dt.date(2020,6,1), dt.date(2020,8,15), dt.date(2020,11,1), dt.date(2020, 12, 8), dt.date(2020,12,25), dt.date(2020,12,26),			
		}
